...
import { calendarInitialResolver } from './resolvers/calendar-initial.resolver';
...
export const congeRoutes: Routes = [
  ...
  { path: 'calendar', loadComponent: () => import('./page/calendar/calendar.component').then(m => m.CongeCalendarComponent), resolve: { initialConges: calendarInitialResolver }, data: { breadcrumb: 'Calendrier' } },
